        ...
        <div class="mx-auto mt-10 w-96 p-6 space-y-4 md:space-y-6 sm:p-8 0 bg-table rounded-lg">
            ...
            <form ref={formRef} onSubmit={onSignUpSubmit} class="space-y-4 md:space-y-6" action="#">
                <div>
                    ...
                    <input type="email" name="email" id="email" class=" border focus:!outline-none transition-this sm:text-sm rounded-lg  block w-full p-2.5 bg-secondary border-gray-600 placeholder-gray-300  focus:ring-blue-500 focus:border-blue-500" placeholder="name@company.com" required />
                </div>

                <div>
                    <label for="username" class="block mb-2 text-sm font-medium ">Имя пользователя</label>
                    <input type="text" name="username" id="text" class=" border focus:!outline-none transition-this sm:text-sm rounded-lg  block w-full p-2.5 bg-secondary border-gray-600 placeholder-gray-300  focus:ring-blue-500 focus:border-blue-500" placeholder="имя..." required />
                </div>
                ...
                <button type="submit" class="w-full  bg-primary transition-this focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Создать</button>
